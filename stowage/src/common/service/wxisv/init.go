...
-----END PRIVATE KEY-----`
	...
	tNotifyUrl := debugNotifyUrl
	if beego.BConfig.RunMode == "prod" {
		tNotifyUrl = notifyUrl
	}

	var err error
	Client, err = wxisv.NewClient(appId, mchId, key, appSecret, tNotifyUrl, caString, certString, keyString, false)
	if err != nil {
		return err
	}
	Pay = wxisv.NewPay(Client)
